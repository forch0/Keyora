...
return [
    ...
    /*
    * Email addresses allowed to view API docs in non-local environments.
    * Used by the viewApiDocs gate (AppServiceProvider).
    */
    'allowed_emails' => array_filter(explode(',', (string) env('SCRAMBLE_ALLOWED_EMAILS', ''))),
];
