...
class BulkOperationsTest extends TestCase
{
    ...
    public function test_bulk_delete_personal_vault_items(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders($token))
            ->postJson('/api/v1/personal-vault/items/bulk/delete', ['ids' => $ids]);
    ...
    public function test_bulk_move_to_folder(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders($token))
            ->postJson('/api/v1/personal-vault/items/bulk/move', [
                'ids' => $ids,
                'folder_id' => $folder->id,
            ]);
    ...
    public function test_bulk_archive_items(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders($token))
            ->postJson('/api/v1/personal-vault/items/bulk/archive', ['ids' => $ids]);
    ...
    public function test_bulk_restore_items(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders($token))
            ->postJson('/api/v1/personal-vault/items/bulk/restore', ['ids' => $ids]);
    ...
    public function test_bulk_tag_attach(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders($token))
            ->postJson('/api/v1/personal-vault/items/bulk/tag', [
                'ids' => $ids,
                'tag_ids' => $tagIds,
                'action' => 'attach',
            ]);
    ...
    public function test_bulk_create_imports_items(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders($token))
            ->postJson('/api/v1/personal-vault/items/bulk/create', [
                'items' => [
    ...
    public function test_bulk_create_max_50(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders($token))
            ->postJson('/api/v1/personal-vault/items/bulk/create', ['items' => $items]);
    ...
    public function test_bulk_operation_logs_activity(): void
    {
        ...
        $this->withHeaders($this->authHeaders($token))
            ->postJson('/api/v1/personal-vault/items/bulk/delete', ['ids' => $items->pluck('id')->toArray()]);
